...
<div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="label-title" id="modal-cambiar-direccion">
    <div class="modal-dialog" role="document">
        <form id="form-cambiar-direccion" action="{{url('pedidos/update/direccion')}}" onsubmit="return false;" enctype="multipart/form-data" method="POST" autocomplete="off" data-ajax-type="ajax-form" data-column="0" data-refresh="table" data-redirect="" data-table_id="" data-container_id="" data-keep_modal="false">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-success save btn-generar-excel" data-target-id="form-cambiar-direccion">Modificar dirección</button>
                </div>
            </div><!-- /.modal-content -->
        </form>
    </div><!-- /.modal-dialog -->
