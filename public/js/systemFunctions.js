$(function() {
    ...
    $("#calcularPrecios").click(function() {
        if($("#precio_base").val() != "" && $("#precio_base").val() > 0) {
            var value = parseFloat($("#precio_base").val());
            $("#precio_a").val(parseFloat(value + 0.06).toFixed(2));
            $("#precio_b").val(parseFloat(value + 0.10).toFixed(2));
            $("#precio_c").val(parseFloat(value + 0.20).toFixed(2));
            $("#precio_d").val(parseFloat(value + 0.30).toFixed(2));
            $("#precio_e").val(parseFloat(value + 0.40).toFixed(2));
        } else {
            $("#precio_a, #precio_b, #precio_c, #precio_d, #precio_e").val(0);
        }
    });
